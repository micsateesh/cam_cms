...
ActiveRecord::Schema.define(version: 20180528100733) do
  ...
  add_index "cama_media", ["folder_path"], name: "index_cama_media_on_folder_path"
  add_index "cama_media", ["is_folder"], name: "index_cama_media_on_is_folder"
  add_index "cama_media", ["name"], name: "index_cama_media_on_name"
  add_index "cama_media", ["site_id"], name: "index_cama_media_on_site_id"
